      ...
      <div className="grid h-auto min-h-[100vh] w-full grid-cols-[188px_minmax(0,1fr)] grid-rows-[80px_calc(100vh-80px)_minmax(0,1fr)] flex-col [grid-template-areas:'a1_b1''a2_b2''a3_b3']">
        ...
        <aside className="sticky top-[0px] flex h-[100vh] flex-col items-center bg-[#171717] pt-[80px] [grid-area:a1/a1/a2/a2]">
          <nav>
            ...
            >
              <img className="m-[4px] size-[20px] shrink-0 grow-0" src={isSignedIn ? '/public/fa-solid--sign-out-alt.svg' : '/public/fa-solid--user.svg'} />
            ...
            <Link
              ...
              to="/"
            >
              <img className="m-[4px] size-[20px] shrink-0 grow-0" src="/public/bi--house-fill.svg" />
            ...
            <Link
              ...
              to="/timetable"
            >
              <img className="m-[4px] size-[20px] shrink-0 grow-0" src="/public/fa-solid--calendar.svg" />
